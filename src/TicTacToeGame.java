...
public class TicTacToeGame {
	...
	//This is for Player X Only//
		...
		{
			JOptionPane.showMessageDialog(frame, "No One Wins","Tic Tac Toe Game",JOptionPane.INFORMATION_MESSAGE);
	...
	private void initialize() {
		...
		btnReset.setFont(new Font("Dialog", Font.BOLD, 21));
		...
		btnExit.setFont(new Font("Dialog", Font.BOLD, 21));
